...
def seed_db():
    with app.app_context():
        ...
        terms_data = [
            ...
            {'name': 'Оверфит', 'transcription': '[оʊвəрфит]', 'grammar': 'сущ., м.р.', 'origin_word': 'Overfitting', 'year': '2010–н.в.', 'def': 'Переобучение модели, когда она запоминает данные вместо обучения.', 'ex': 'Модель словила оверфит, нужно добавить регуляризацию.', 'cat': 'AI/ML', 'src': github},
            ...
            {'name': 'Зеро-дей', 'transcription': '[зɪроʊ дэй]', 'grammar': 'сущ., м.р.', 'origin_word': 'Zero-day vulnerability', 'year': '2000–н.в.', 'def': 'Уязвимость, о которой неизвестно производителю.', 'ex': 'Обнаружили зеро-дей уязвимость в браузере.', 'cat': 'Безопасность', 'src': github},
            ...
            {'name': 'Абишка', 'transcription': '[аˈбишкə]', 'grammar': 'сущ., ж.р.', 'origin_word': 'API (жарг.)', 'year': '2010–н.в.', 'def': 'Программный интерфейс приложения (жаргонное).', 'ex': 'Документируем нашу абишку для партнёров.', 'cat': 'Разработка', 'src': habr},
            {'name': 'Бэкенд', 'transcription': '[ˈбэкэнд]', 'grammar': 'сущ., м.р.', 'origin_word': 'Backend', 'year': '2000–н.в.', 'def': 'Серверная часть приложения.', 'ex': 'Бэкенд написан на Python.', 'cat': 'Разработка', 'src': stackoverflow},
            {'name': 'Фронтенд', 'transcription': '[ˈфронтэнд]', 'grammar': 'сущ., м.р.', 'origin_word': 'Frontend', 'year': '2000–н.в.', 'def': 'Клиентская часть приложения, интерфейс.', 'ex': 'Фронтенд делаем на React.', 'cat': 'Разработка', 'src': github},
            {'name': 'Фуллстек', 'transcription': '[ˈфуллстэк]', 'grammar': 'сущ., м.р.', 'origin_word': 'Fullstack', 'year': '2010–н.в.', 'def': 'Разработчик, работающий и с фронтендом, и с бэкендом.', 'ex': 'Нам нужен фуллстек на JavaScript.', 'cat': 'Разработка', 'src': linkedin},
            {'name': 'Рефакторинг', 'transcription': '[рифакˈторинг]', 'grammar': 'сущ., м.р.', 'origin_word': 'Refactoring', 'year': '2000–н.в.', 'def': 'Улучшение структуры кода без изменения функциональности.', 'ex': 'Сделали рефакторинг старого модуля.', 'cat': 'Разработка', 'src': habr},
            {'name': 'Депрекитед', 'transcription': '[дэприˈкейтед]', 'grammar': 'прил.', 'origin_word': 'Deprecated', 'year': '2000–н.в.', 'def': 'Устаревший, не рекомендуемый к использованию.', 'ex': 'Этот метод помечен как депрекитед.', 'cat': 'Разработка', 'src': stackoverflow},
            {'name': 'Хардкод', 'transcription': '[ˈхардкод]', 'grammar': 'сущ., м.р.', 'origin_word': 'Hardcode', 'year': '1995–н.в.', 'def': 'Данные, вшитые прямо в код.', 'ex': 'В конфиге был хардкод, пришлось выносить.', 'cat': 'Разработка', 'src': github},
            {'name': 'Воркфлоу', 'transcription': '[ˈворкфлоу]', 'grammar': 'сущ., м.р.', 'origin_word': 'Workflow', 'year': '2010–н.в.', 'def': 'Рабочий процесс, последовательность действий.', 'ex': 'Оптимизировали воркфлоу разработки.', 'cat': 'Менеджмент', 'src': medium},
            {'name': 'Апрув', 'transcription': '[аˈпрув]', 'grammar': 'сущ., м.р.', 'origin_word': 'Approve', 'year': '2010–н.в.', 'def': 'Одобрение, утверждение.', 'ex': 'Ждём апрув от тимлида на мерж.', 'cat': 'Менеджмент', 'src': github},
            {'name': 'Блокер', 'transcription': '[ˈблокер]', 'grammar': 'сущ., м.р.', 'origin_word': 'Blocker', 'year': '2005–н.в.', 'def': 'Проблема, блокирующая работу.', 'ex': 'Этот баг — блокер для релиза.', 'cat': 'Менеджмент', 'src': vc}
        ]
